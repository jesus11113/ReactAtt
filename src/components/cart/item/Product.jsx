...
const Product = (props) => {
    ...
    return (
        <div className={style.cart_item}>
            ...
            <img className={style.cart_img} src={props.img} alt="убежала"></img>
            <p className={style.cart_title}>{props.title} </p>
            <p className={style.cart_description}>ВОТ ЗДЕСЬ ДОЛЖНО БЫТЬ КРУТОЕ ОПИСАНИЕ ЭТИХ КОВАНЫХ НОЖЕЙ{props.description}</p>
