...
function App() {
    ...
    React.useEffect(() => {
        ...
        async function axiosData(){
            ...
            const tyrsData = await axios.get('https://64416e55fadc69b8e08407f5.mockapi.io/tyrs')
            const cartData = await axios.get('https://64416e55fadc69b8e08407f5.mockapi.io/cart')
    ...
    const deleteItems=(id)=>{
        console.log(id);
        axios.delete(`https://64416e55fadc69b8e08407f5.mockapi.io/cart/${id}`)
